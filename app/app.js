...
var timer =  setInterval(function(){
  const temps = document.getElementById('temps');
    ...
    congratsMessage.textContent = 'FELICITATS! Ho has aconseguit amb:';
    ...
    temps.textContent = timerText.textContent;
...
var stop = btnStart.addEventListener("click", function(){
  ...
  setInterval(function(){
        countTime += 1;
        timerText.textContent = countTime + " segons";
...
play.addEventListener("click", function(){
  ...
  counterMove+= 1;
  moveText.textContent = counterMove + " moviments";
  }
});
